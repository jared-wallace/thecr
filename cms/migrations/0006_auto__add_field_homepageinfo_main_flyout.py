...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomepageInfo.main_flyout'
        db.add_column('cms_homepageinfo', 'main_flyout',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomepageInfo.main_flyout'
        db.delete_column('cms_homepageinfo', 'main_flyout')
